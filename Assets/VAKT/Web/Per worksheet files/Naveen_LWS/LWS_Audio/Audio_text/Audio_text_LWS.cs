...
public class Audio_text_LWS : MonoBehaviour
{
   ...
   // public GameObject G_Selected2;
    ...
    public void THI_ShowQusetion()
    {
        ...
        for (int i = 0; i < G_Option.transform.childCount; i++)
        {
            ...
            G_Option.transform.GetChild(i).transform.GetChild(0).GetComponent<Text>().text = STRL_options[I_Dummy];
            G_Option.transform.GetChild(i).GetComponent<AudioSource>().clip = ACA_optionClips[I_Dummy];
            G_Option.transform.GetChild(i).name = STRL_options[I_Dummy];
            G_Option.transform.GetChild(i).GetComponent<Image>().color = Color.white;
        }
    ...
    public IEnumerator IN_CoverImage()
    {
       ...
       if (IL_numbers[3] == 4)
        ...
        if (IL_numbers[3] == 8)
        {
            ...
            G_Option = GA_Options[3].gameObject;
            G_Option.SetActive(true);
        }
        else
        if (IL_numbers[3] == 10)
        {
            ...
            G_Option = GA_Options[4].gameObject;
            G_Option.SetActive(true);
        }
       // 
