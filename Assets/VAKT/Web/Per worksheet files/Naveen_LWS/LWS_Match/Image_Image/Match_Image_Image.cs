...
public class Match_Image_Image : MonoBehaviour
{
    ...
    public Sprite[] SPRA_Options, SPRA_Question;
    ...
    void THI_ShowQuestion()
    {
        ...
        for (int i = 0; i < SPRA_Question.Length; i++)
        {
    ...
    void THI_checkEmojiResult()
    {
        ...
        Debug.Log("Answer = " + I_correctAnsCount);
